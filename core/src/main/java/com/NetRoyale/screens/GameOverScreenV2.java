...
/**
 * Game Over Screen V2 - With Level Progression
 * Integrates Strategy Pattern for level system
 */
public class GameOverScreenV2 implements Screen {
    ...
    public GameOverScreenV2(NetRoyale game, boolean victory, String message) {
        this.game = game;
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (playAgainButton.contains(mouseX, mouseY)) {
                game.setScreen(new DeckBuilderScreenV2(game));
            }
        }
    }
